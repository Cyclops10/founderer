			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 800, 'gridheight': 600}">
						<ul>
							<li data-transition="fade">
								...
								<img src="front/img/slides/slide-corporate-6.jpg"
									alt=""
								...
								<div class="tp-caption tp-caption-overlay tp-caption-overlay-primary main-label"
									...
									data-mask_in="x:0px;y:0px;">WELCOME TO PORTO</div>
							...
							<li data-transition="fade">
								<img src="front/img/demos/digital-agency/slides/slide-digital-agency-1.jpg"
									alt=""
									data-bgposition="center center"
									data-bgfit="cover"
									data-bgrepeat="no-repeat"
								...
								<div class="tp-caption tp-caption-overlay tp-caption-overlay-primary main-label"
									...
									data-transform_in="y:[100%];s:500;"
									data-transform_out="opacity:0;s:500;"
									data-mask_in="x:0px;y:0px;">DIGITAL AGENCY</div>

								<div class="tp-caption tp-caption-overlay-opacity bottom-label"
									data-x="center"
									data-y="358"
									data-start="2000"
									data-transform_in="y:[100%];opacity:0;s:500;">We Create Amazing Solutions for Our Clients</div>
							</li>
						</ul>
					</div>
				</div>
				<div class="container">
					<div class="row justify-content-center mt-5">
						<div class="col-lg-10">
								...
								<ul class="nav nav-tabs">
									...
									<li class="nav-item">
										<a class="nav-link" href="#tabsNavigationSimpleIcons3" data-toggle="tab">
											...
											<p class="mb-0 pb-0">Development</p>
										</a>
									</li>
									<li class="nav-item">
							...
							<p class="text-center">
								<a class="btn btn-light mt-3 mb-3" href="demo-digital-agency-services.html">Learn More <i class="fa fa-angle-right pl-1"></i></a>
							</p>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-12 text-center">
								<h2 class="mb-0 mt-0 font-weight-semibold text-light">Who We Are:</h2>
								...
								<p class="mb-0 text-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque neque eget diam posuere porta. Quisque ut nulla at nunc <a href="#">vehicula</a> lacinia. Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In eu libero ligula. Fusce eget metus lorem, ac viverra leo. Nullam convallis, arcu vel pellentesque sodales, nisi est varius diam, ac ultrices sem ante quis sem. Proin ultricies volutpat sapien, nec scelerisque ligula mollis lobortis.</p>

								<a class="btn btn-primary mt-5 mb-2" href="demo-digital-agency-about.html">Learn More <i class="fa fa-angle-right pl-1"></i></a>
							</div>
						</div>
					</div>
				</section>
				<section class="mt-5 mb-0 pb-0">
					<div class="container">
						<div class="row">
							<div class="col-lg-12 text-center">
								<h2 class="mb-0 font-weight-semibold">Recent Work:</h2>
								<p class="lead mb-3">Pellentesque pellentesque eget tempor tellus. </p>
									...
									<div class="owl-carousel owl-theme m-0" data-plugin-options="{'autoHeight': true, 'items': 1, 'margin': 10, 'nav': true, 'dots': false, 'stagePadding': 0}">
										<div>
											<a href="demo-digital-agency-work-detail.html">
												<img alt="" class="img-fluid" src="front/img/previews/areas/content-7.png">
											</a>
										</div>
										<div>
											<a href="demo-digital-agency-work-detail.html">
												<img alt="" class="img-fluid" src="front/img/previews/areas/content-5.png">
											</a>
										</div>
									</div>
								</div>
				...
				<section class="section section-tertiary section-front mt-0">
					<div class="container">
						<div class="row">
							<div class="col-lg-12 text-center">
								<div class="row">
									<div class="col-lg-12 text-center">
										<h2 class="mb-0 font-weight-semibold text-dark">Who Loves Us</h2>
										<p class="lead mb-3">Pellentesque pellentesque eget tempor tellus. </p>
										<div class="divider divider-primary divider-small divider-small-center mb-3">
											<hr>
										</div>
								...
								<div class="row justify-content-center">
									<div class="col-md-10 col-lg-4">
										<div class="testimonial testimonial-style-2 appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="300">
											...
											<div class="testimonial-author">
												<img src="front/img/clients/client-1.jpg" class="img-fluid rounded-circle" alt="">
									...
									<div class="col-md-10 col-lg-4">
										<div class="testimonial testimonial-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="600">
											...
											<div class="testimonial-arrow-down"></div>
											<div class="testimonial-author">
												<img src="front/img/clients/client-2.jpg" class="img-fluid rounded-circle" alt="">
									...
									<div class="col-md-10 col-lg-4">
										<div class="testimonial testimonial-style-2 appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="700">
											...
											<div class="testimonial-arrow-down"></div>
											<div class="testimonial-author">
												<img src="front/img/clients/client-3.jpg" class="img-fluid rounded-circle" alt="">
