...
<html class="fixed header-dark" lang="{{ app()->getLocale() }}">
	...
	<body>
			...
			<header class="header">
				<div class="logo-container">
					<a href="../2.0.0" class="logo">
						<img src="{{URL::asset('img/logo.png')}}" width="75" height="35" alt="Porto Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{URL::asset('img/!sample-user.jpg')}}" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{URL::asset('img/!sample-user.jpg')}}" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{URL::asset('img/!sample-user.jpg')}}" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{URL::asset('img/!logged-user.jpg')}}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg" />
							</figure>
										...
										<header class="card-header bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="{{URL::asset('img/!logged-user.jpg')}}">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="{{URL::asset('img/projects/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
																<img class="img-fluid" width="215" src="{{URL::asset('img/projects/project-4.jpg')}}">
																<span class="zoom">
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="{{URL::asset('img/!sample-user.jpg')}}" alt="Joseph Doe" class="rounded-circle">
										</figure>
										<div class="profile-info">
		...
		<script src="{{URL::asset('vendor/jqueryui-touch-punch/jqueryui-touch-punch.js')}}"></script>
		...
		<script src="{{URL::asset('vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.js')}}"></script>
		<script src="{{URL::asset('vendor/flot/jquery.flot.js')}}"></script>
		<script src="{{URL::asset('vendor/flot.tooltip/flot.tooltip.js')}}"></script>
		...
		<script src="{{URL::asset('vendor/jqvmap/jquery.vmap.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/data/jquery.vmap.sampledata.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/jquery.vmap.world.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.africa.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.asia.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.australia.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.europe.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.north-america.js')}}"></script>
		<script src="{{URL::asset('vendor/jqvmap/maps/continents/jquery.vmap.south-america.js')}}"></script>
